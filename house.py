...
grid = sns.FacetGrid(train_df, col='SalePrice', row='LotArea', size=2.2, aspect=1.6)
grid.map(plt.hist, 'Age', alpha=.5, bins=20)
grid.add_legend();
plt.plot(train_df[['LotArea', 'SalePrice']])
...
#Create new features extracting from existent
for dataset in combine:
